!function (t, e) {
    ...
    "use strict";
    var e, o, c = e = c || {version: "1.5.0"};

    function n() {
    }

    function i(t, e) {
        this._name = t, this._baseZoom = 18, this._opts = {tileSize: 256}, c.extend(this._opts, e || {})
    }
    ...
    c.guid = "$BAIDU$", window[c.guid] = window[c.guid] || {}, c.object = c.object || {}, c.extend = c.object.extend = function (t, e) {
        ...
        var n = t.style[e];
        if (!n) {
            var i = o._styleFixer[e], r = t.currentStyle || getComputedStyle(t, null);
        ...
        t = c.dom.g(t);
        var e, o, n = c.dom.getDocument(t), i = c.browser, r = c.dom.getStyle,
        ...
        if (t.getBoundingClientRect) {
            ...
            var s = n.body, l = parseInt(r(s, "borderLeftWidth")), d = parseInt(r(s, "borderTopWidth"));
        ...
        if (c.lang.isFunction(e)) e = e.hashCode; else if (!c.lang.isString(e)) return;
        ...
        var n = this.__listeners, i = t.type;
        ...
        var n, i, r = t.prototype, a = new Function;
    ...
    var a = 52.35987755982988, r = [12890594.86, 8362377.87, 5591021, 3481989.83, 1678043.12, 0],
        ...
        m = {
            setPosition: function (t, e) {
                ...
                for (var n, i, r, a = !1, s = !1, l = !1, d = {x: t.x, y: t.y}, c = {
                    x: e.x,
                    y: e.y
                ...
                if (a) return {pixel0: new Pixel(d.x, d.y), pixel1: new Pixel(c.x, c.y), clip: !!s}
            }, calcOutcode: function (t, e) {
                var o = {top: 0, bottom: 0, right: 0, left: 0, all: 0}, n = t.x, i = t.y;
                ...
                var s = [];
                if (e <= o) {
                    var l = t.slice(0, n), d = t.slice(n, t.length), c = this.douglasPeucker(l, e),
                ...
                var n = this.convertLL2MC([t, e]), i = n[0] * Math.pow(2, o - 18), r = n[1] * Math.pow(2, o - 18);
                ...
                var o = this, e = $.extend(!0, {}, {points: [], from: 0, to: 0}, t), n = [];
                ...
                var i = this, r = [], e = t.split(",");
                return $.trim(e[0]) === $.trim(e[e.length - 1]) && e.pop(), $.each(e, function (t, e) {
                    var o = $.trim(e).split(" "), n = i.pointToLngLat(o[0], o[1]);
                ...
                if (t && e) {
                    var o = e[0] + e[1] * Math.abs(t[0]), n = Math.abs(t[1]) / e[9],
                ...
                var e = {lng: 0, lat: 0}, o = t.lng, n = t.lat, i = Math.sqrt(o * o + n * n) + 2e-5 * Math.sin(n * a),
                ...
                var e = {lng: 0, lat: 0}, o = t.lng - .0065, n = t.lat - .006,
            ...
            e = e || {}, c.extend(h, e);
            var o = m.create("script", {src: t, type: "text/javascript", charset: "utf-8"});
    ...
    p.prototype = {
        _init: function () {
            ...
            if (this._indoorInfo) {
                ...
                var n = this._btnBottom = m.create("button"), i = m.create("div");
                ...
                var a = 0;
                "" === this._btnTop.style.display && (a = 30), this._div.style.height = parseInt(this._floorsContainer.style.height, 10) + a + "px", this._div.style.top = "20px", this.container.appendChild(this._div);
                var s = this;
                setTimeout(function () {
                    s._div.style.right = "20px"
                }, 20)
            }
            ...
            if (this._indoorInfo) {
                for (var t = this._ol = m.create("ol"), e = this._indoorInfo.currentFloor, o = this._indoorInfo.floors.length - 1; 0 <= o; o--) {
                    var n = this._indoorInfo.floors[o], i = m.create("li"), r = m.create("button");
            ...
            if (this._indoorInfo) {
                var t = window.innerHeight - 291 - 100, e = this._indoorInfo.floors.length, o = 26 * e, n = e, i = 0;
            ...
            var e = this._indoorInfo.floors.length, o = 26 * e;
            ...
            !0 !== this._visible && (this._visible = !0, this._div.style.right = "20px")
        }, hide: function () {
    ...
    var G = {
        parse: function (t, o, e, n, i) {
            var r = n._map, a = n._indoorMgr, s = r.getZoom(), l = Math.pow(2, 18 - s),
                d = a.mercatorProjection.lngLatToPoint(r.getCenter()), c = d.x, h = d.y, u = r.getSize(), f = u.width,
                g = u.height, p = [];
            for (var m in t) if ("parsedLabelData" !== m && s === t[m].tileInfo[2]) {
                var v = [], _ = t[m].tileInfo;
            ...
            if (/collision=0/.test(location.search)) for (var x = [], I = 0; I < p.length; I++) for (w = 0; w < p[I].length; w++) x.push(p[I][w]); else x = this.preComputeLabel(p, n._map.getZoom());
            ...
            if (g) {
                ...
                for (var v = e[0] * i * l, _ = e[1] * i * l, b = 0; b < g.length; b++) {
                    var y = g[b], w = y[0], x = o.getStyleFromCache(w, "point", m, f),
                        I = o.getStyleFromCache(w, "pointText", m, f), S = y[1];
                    if (S) {
                        var M = null, C = 100, T = 0, D = 0;
                        ...
                        for (var L = 0; L < S.length; L++) {
                            ...
                            if (P) {
                                var R = P[2];
                                if (o.isVisible(R, s)) {
                                    var B = Math.round(P[0] / 100), k = Math.round(P[1] / 100),
                                        A = {lng: v + B, lat: _ + k}, F = B / l + r, Z = i - k / l + a;
                                    if (u || !(F < -50 || Z < -50 || d + 50 < F || c + 50 < Z)) {
                                        ...
                                        if (I) {
                                            var X = P[5];
                                            "number" != typeof X && (X = 0);
                                            var Y = 0, z = 0, U = I.fontSize / 2, j = .2 * U;
                                            p.font = G.getFontStyle(I, o);
                                            var V = E.split("\\"), H = V.length;
                                            N.direction = X;
                                            for (var K = 0; K < H; K++) {
                                                var q = V[K], W = p.measureText(q).width;
                                                switch (X) {
                                                    case 3:
                                                ...
                                                N.textPos.push({destX: Y, destY: z, width: W, height: U, text: q})
                                            }
                                        }
                                        h.push(N)
                                    }
            ...
            if (G.iconCache[r]) {
                ...
                var s = o.getIconUrl(r), l = new Image, d = this;
                l.onload = function () {
                    G.iconCache[r] = this, d.drawIconImage(t, e, this, n, i), l.onload = null
                }, l.src = s
            }
        }, drawIconImage: function (t, e, o, n, i) {
            var r = e.iconPos, a = r.destX, s = r.destY, l = null, d = null, c = !0, h = e.style ? e.style.sid : null;
            if (e.style && 62203 === h) {
            ...
            var a = e.originPos[0] - i / 2, s = e.originPos[1] - r / 2;
            ...
            var a = e.originPos[0] - i / 2, s = e.originPos[1] - r / 2, l = n / 2;
            ...
            var o = 2 === t.fontWeight ? "italic" : "", n = t.fontSize / 2, i = o;
            ...
            for (var i = 0, r = t.length; i < r; i++) for (var a = t[i], s = (a.x, a.y, a.z, 0), l = a.length; s < l; s++) {
                var d = a[s], c = void 0, h = void 0, u = void 0, f = void 0;
                if ("fixed" === d.type) {
                    var g = d.iconPos, p = d.textPos;
                ...
                } else if ("line" === d.type) c = d.minX, h = d.minY, u = d.maxX, f = d.maxY; else if ("biaopai" === d.type) {
                    var _ = d.pos;
    ...
    v.prototype = {
        _initVars: function (t) {
            ...
            var t = m.create("canvas"), e = t.style;
            ...
            var n = t.textPos, i = this.ratio, r = this.sizeRatio / i, a = this._colorCtx, s = this._colorCvsSize;
            a.clearRect(0, 0, s, s);
            for (var l = t.style, d = (l = {
                ...
                var p = n[f], m = p.text, v = (p.destX - t.minX) / r, _ = d * (f + 1) + c * f - 1 / r;
            ...
            t.addEventListener("onhotspotover", function (t) {
                ...
                if (t.spots[0].tag === n.indoorHotspotTarget) if (t.spots && 0 < t.spots.length) {
                    var e = t.spots[0].getUserData().uid, o = i.findLabelByUid(e);
            ...
            if (!t._tempRank || t._tempRank != this.RANK5) {
                ...
                if (e) {
                    var o = Math.round(e[0]), n = Math.round(e[1]), i = this.getLabelImageData(t, o, n), r = i[0],
                        a = i[1], s = this.getFilterImageData(r, this.RANK5);
    ...
    var _ = {
        drawPoly: function (t, e, o, n, i, r) {
            ...
            if (a) for (var s = t[6], l = 0; l < a.length; l++) {
                var d = a[l][0], c = i.getStyleFromCache(d, "polygon", o, r);
                if (c && c.length || (c = i.getStyleFromCache(d, "polygon", o - 1, r)), c && c.length) for (var h = a[l][1], u = 0; u < h.length; u++) {
                    var f, g = h[u][1], p = g[0];
                    if (i.isVisible(p, o)) {
                        if (!g["cache" + o]) {
                            g["cache" + o] = i.parseMidPoint(g[1], o, n, s);
                            f = g["cache" + o];
                            this.drawSurface(e, f, c);
                        }
                    }
                }
            }
            ...
            for (var i = 0, r = e.length; i < r; i += 2) {
                // FIXME: 搞不定
                debugger
                var pixel_x = e[i] + t.offsetX;
                var pixel_y = e[i+1] + t.offsetY;
                var p = map.pixelToPoint(pixel_x, pixel_y);
    ...
    b.prototype = {
        parse: function (t, e, o) {
            ...
            for (var n = o, i = {}, r = [], a = [], s = 0; s < t.length; s++) {
                ...
                // debugger
                // 外围
                // for (var i=0; i<d.contoursCoords[0].length; i+=2) {
                //     console.log(m.pointToLngLat(d.contoursCoords[0][i], d.contoursCoords[0][i+1]))
                // }
            }
            ...
            if (!t || !t[0] || !t[0][1]) return {contoursCoords: [], center: [0, 0]};
            for (var o = [], n = [0, 0], i = [20037726.37, 11028190.87], r = [-20037726.37, -10601580.79], a = 0, s = e.col, l = e.row, d = e.mercatorSize, c = s * d, h = l * d, u = 0; u < t.length; u++) {
                var f = t[u][1], g = [c + f[0] / 100, h + f[1] / 100];
            ...
            return n[0] /= a / 2, n[1] /= a / 2, {contoursCoords: o, center: n, boundsMin: i, boundsMax: r}
        }, draw: function (t, e, o, n) {
            // debugger
            n = n || {};
            for (var i = o.tileSize, r = 0; r < e.length; r++) {
                var a, s = e[r][0], l = e[r][1][0];
    ...
    var y = {}, w = {}, x = {}, I = {}, S = (window.FeatureStyle, window.indoorStyle, window.iconSetInfo_high),
        M = f.iconUrls, C = {
            3: {start: 3, base: 3},
            4: {start: 4, base: 5},
            5: {start: 4, base: 5},
    ...
    T.prototype = {
        loadStyle: function () {
            ...
            var i = n || window.FeatureStyle, r = i[2];
            ...
            for (var e in t) {
                var o = t[e];
                return {color: this.parseRgba(o[0]), iconType: o[1], icon: o[2]}
            }
        }, parseRgba: function (t) {
            var e = t;
            if (I[e]) return I[e];
            var o = 255 & (t >>>= 0), n = t >> 8 & 255, i = t >> 16 & 255, r = (t >> 24 & 255) / 255;
            ...
            if (o || 48 <= t.charCodeAt(0) && t.charCodeAt(0) <= 57 && (o = S["_" + t]), o) {
                var n = o[0] / 2 * e, i = o[1] / 2 * e, r = Math.round(-n / 2), a = Math.round(-i / 2), s = r + n,
                    l = a + i;
                return {vertex: [r, a, s, a, s, l, r, a, s, l, r, l], texcoord: null, width: n, height: i, iconType: t}
            }
            return null
        }, addBounds: function (t) {
            var e = 1e3, o = 1e3, n = -1e3, i = -1e3;
            ...
            for (f = 0; f < l; f++) {
                ...
                h += y;
                var x = g + Math.round(b), I = p, S = x, M = I + Math.round(y), C = g, T = M, D = v / n,
                    L = (i - _ - y * a) / i, P = (v + b * a) / n, R = L, B = P, k = (i - _) / i, A = D, F = k;
                d.push(g, p, x, I, S, M, g, p, S, M, C, T), c.push(D, L, P, R, B, k, D, L, B, k, A, F)
            }
            return {vertex: d, texcoord: c}
        }, parseMidPoint: function (t, e, o) {
            var n = [], i = C[e].base, r = Math.pow(2, e - i) / 100, a = t[0] * r, s = t[1] * r;
            n[n.length] = a, n[n.length] = o - s;
            for (var l = 2; l < t.length; l += 2) a += t[l] * r, s += t[l + 1] * r, n[n.length] = a, n[n.length] = o - s;
            return n
        }, getIconUrl: function (t) {
            var e = t.length % M.length, o = this.getIconVersionInfo(), n = o.ver, i = o.udt;
            return M[e] + t + ".png?v=" + n + "&udt=" + i
        }, getIconVersionInfo: function () {
            if (this.iconVersionInfo) return this.iconVersionInfo;
            var t = "undefined" != typeof MSV ? MSV.mapstyle : {}, e = t.version ? t.version : "001",
                o = t.updateDate ? t.updateDate : "20150621";
            return this.iconVersionInfo = {ver: e, udt: o}, this.iconVersionInfo
        }
    };
    var D = c.lang.Event;
    ...
    L.prototype = {
        _init: function () {
            ...
            t.authentic_key = e.getKey(), t.authentic_key && (t._checkZoom(), BMAP_NORMAL_MAP.setMaxZoom(t.config.maxZoom), e.setMaxZoom(t.config.maxZoom), t._map.highResolutionEnabled() && (t.scaler = 2), t.vectorDrawLib = new T(e, t), t.indoorDrawLib = t.vectorDrawLib.indoorDrawLib, t._bind(), setTimeout(function () {
                e.initIndoorLayer({
                    tileUrls: f.tileUrls,
                    urlOpts: {styles: "pl", extdata: 1, textimg: 0, mesh3d: 0},
            ...
            c.addEventListener("updateindoor", function (t) {
                var e = t.IndoorCanvas[0], o = e.data;
                if (g.config.enableIndoor && g._map.getZoom() >= g.config.minZoom && void 0 !== o && void 0 !== o[1]) {
                    var n = e.canvasID;
                    g.setTileCache(n, e);
                    var i = e.canvasDom, r = i.getContext("2d");
                    g.ratio = e.ratio;
                    var a = n.split("_"), s = parseInt(a[2], 0), l = parseInt(a[3], 0), d = parseInt(a[4], 0),
                        c = parseInt(a[5], 0), h = g._tileType.getTileSize(c), u = {
                            baseTileSize: 1024,
                            col: s,
                            loopOffsetX: 0,
                ...
                var e = t.uid, o = t.floor;
                if (g.temp.indoorId && g.temp.indoorId === e && (g.temp.indoorId = null, g.temp.indoorFloor = null), g.config.showBaseMap ? g.showBaseMap() : g.hideBaseMap(), null === e) e = g.currentUid, g._indoorData[e] && (o = g._indoorData[e].defaultFloor), g._indoorControl && g._indoorControl.hide(), g.currentUid = null, g.enterMethod = null; else if (g._indoorData[e]) {
                ...
                if (e) {
                    var o = e.data, n = e.canvasDom.getContext("2d"), i = e.tileInfo;
                ...
                if ((!t.overlay || t.overlay instanceof BMap.Polygon) && t.point) {
                    ...
                    var n = o.spots || {};
                    for (var i in n) {
                        var r = n[i].getPosition(), a = g.mercatorProjection.lngLatToPoint(r);
            ...
            var e = this, o = t.buildingId, n = t.floor, i = t.maxZoom, r = t.minZoom;
            ...
            if (n._indoorData[t]) {
                ...
                var i = n._indoorData[t], r = i.lnglat, a = new BMap.Point(r[0], r[1]), s = i.name;
                n._map.panTo(a), n.currentUid = t, n.showIndoor(t, e);
                var l = {status: 0, info: {uid: t, center: a, address: n._indoorAddres[t], name: s}};
            ...
            var a = "cbk_indoor_" + r.callbackNum++,
                ...
                s = {status: 0, info: null};
            BMap[a] = function (t) {
                if (s.status = t.uii_err, 0 === t.uii_err) {
                    var e = t.content;
                    r._indoorAddres[i] = e.addr;
                    var o = {uid: e.uid, name: e.name, address: e.addr, center: ""};
            ...
            }), s = 0; s < a.length; s++) n.push({indoorLabelData: a[s]});
            o.curViewLabels[r] = n
            ...
            if (this.labelCanvas) {
                ...
                var e = this._tileType, o = t.getZoom(), n = e.getDataZoom(t.getZoom()), i = Math.pow(2, o - n);
            ...
            var t = this._map.getSize(), e = t.width, o = t.height, n = this.ratio;
            this.labelCtx && this.labelCtx.clearRect(0, 0, e * n, o * n)
        }, _checkZoom: function () {
            c.isMobile && (this.initMaxZoom = this.mobileInitMaxZoom);
            var t = this.initMinZoom, e = this.initMaxZoom, o = this.config;
            o.minZoom < t && (o.minZoom = t), o.maxZoom > e && (o.maxZoom = e)
        }, _checkIndoorByMove: function () {
            var t = this, e = t._map, o = e.getSize(), n = {x: o.width / 2, y: o.height / 2},
                i = (Math.max(o.width, o.height), []);
            for (var r in t._indoorData) {
                var a = e.pointToPixel({lng: t._indoorData[r].lnglat[0], lat: t._indoorData[r].lnglat[1]}),
                    s = m.getDistanceByPixel(n, a);
                i.push({uid: r, distance: s})
            }
            if (0 !== i.length) {
                i.sort(function (t, e) {
                ...
                if (!1 === h && "e96b44200baa3b4082288acc" === l.uid) {
                    var f = t._indoorData[l.uid].boundsMin, g = t._indoorData[l.uid].boundsMax;
            ...
            if (window.FeatureStyle && window.iconSetInfo_high) {
                var i = t.canvas, r = n.ratio, a = o.tileSize;
            ...
            if (null !== t) {
                ...
                for (var o in t) if ("tileInfo" !== o) {
                    var n = t[o].tileKey;
                    if (e._indoorData[o]) e._indoorData[o][n] || (e._indoorData[o].tileKeys.push(n), e._indoorData[o][n] = !0); else {
            ...
            if (t && 0 !== t.length) {
                ...
                return this.areaSpots[o] = {spot: t, userData: e.userData}, o
            }
            ...
            for (var t = 0, e = this._computedLabels.length; t < e; t++) {
                ...
                if (this.isClickableLabel(o)) {
                    ...
                    }, c = new BMap.Hotspot(i, {userData: d.userdata, offsets: d.offsets});
    ...
    }, t.version = "1.0.1", t.IndoorManager = L, Object.defineProperty(t, "__esModule", {value: !0})
});